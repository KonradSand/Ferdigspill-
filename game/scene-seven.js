var SceneSeven = new Phaser.Class({
  ...
  //  this.message = data.message;
    ...
    create: function() {
      ...
      this.dialogsboxes = [{"line1":"Spillet er ferdig. ","line2":" Woow ", "who":false},{"line1":"Jeg er nå ","line2":"god? ", "who":true}]
    ...
    update: function(time) {
      if(this.dialogsboxes[this.arraytraverse] == undefined){this.scene.start("SceneTwo")}
